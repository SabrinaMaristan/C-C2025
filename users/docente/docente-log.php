...
<body>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="menuLateral"> <!-- off-canvas-start hace qeu el menu se abra desde la izquierda y -1 hace que el menu sea enfocable-->
    ...
    <div class="offcanvas-body d-flex flex-column">
      ...
      <a href="./../../users/adscripto/adscripto-log.php" class="nav-opciones mb-2"  data-i18n="adscripto">Adscripto</a>
      <a href="./../../users/docente/docente-log.php" class="fw-semibold seleccionado mb-2"data-i18n="teacher">Docente</a>
  ...
  <div class="contenedor">
    ...
    <aside class="barra-lateral">
      ...
      <a href="../docente/docente-log.php" class="fw-semibold seleccionado" data-i18n="teacher">Docente</a>
    ...
    <main class="principal">
      <img src="./../../img/logo.png" alt="Logo" class="logo"> 
        ...
        <p id="p-login" data-i18n="logInDescription">Inicia sesión con tu cédula y contraseña para acceder a tu cuenta y comenzar a usar el sistema.</p>
